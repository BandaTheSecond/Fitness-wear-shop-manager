      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-primary-400 mb-4">FitWear</h3>
            <p className="text-gray-300 mb-4">
              Your premier destination for high-quality fitness wear and athletic apparel. 
              We provide the best gear to help you achieve your fitness goals.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025. FitWear. All rights reserved.
            </p>
